...
import { ArtistAvatar, type PhotoSource } from "./ArtistAvatar";
...
const INITIAL_ARTISTS: Artist[] = [
  { id: "cleo-sterling", name: "Cleo Sterling", photo: "629591e353030fa597f22547cf5a231c2df4ca33.png", photoSource: "local", flag: FLAG_MAP["AU"], countryCode: "AU", type: "Solo", since: 2021 },
  { id: "crimson-atlas", name: "Crimson Atlas", photo: "3d50ead32c01ecb5b47119643b3ecca40f989248.png", photoSource: "local", flag: FLAG_MAP["AR"], countryCode: "AR", type: "Group", groupSize: 4, since: 2014 },
  { id: "deep-current", name: "Deep Current", photo: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", photoSource: "local", flag: FLAG_MAP["ZA"], countryCode: "ZA", type: "Group", groupSize: 6, since: 2009 },
  { id: "dmitri-volkov", name: "Dmitri Volkov", photo: "840b1445a965dde9c17ff977f5e596285dd0af2c.png", photoSource: "local", flag: FLAG_MAP["RU"], countryCode: "RU", type: "Solo", since: 2010 },
  { id: "echo-assembly", name: "Echo Assembly", photo: "fd9e78c0d36b29e95d78bc0061110af5925b95bb.png", photoSource: "local", flag: FLAG_MAP["DE"], countryCode: "DE", type: "Group", groupSize: 5, since: 2010 },
  { id: "elara-vind", name: "Elara Vind", photo: "f57af44522dcfc86b6bd37afc67442c47b22ed45.png", photoSource: "local", flag: FLAG_MAP["NO"], countryCode: "NO", type: "Solo", since: 2013 },
  { id: "fractal-dawn", name: "Fractal Dawn", photo: "9db23c15a2487b4f4592608380e712c7d8ede527.png", photoSource: "local", flag: FLAG_MAP["DE"], countryCode: "DE", type: "Group", groupSize: 5, since: 2017 },
  { id: "hana-mizuki", name: "Hana Mizuki", photo: "26d1caa7ae5d95a76994d531f9e7cd874ede70c2.png", photoSource: "local", flag: FLAG_MAP["JP"], countryCode: "JP", type: "Solo", since: 2018 },
  { id: "isla-crane", name: "Isla Crane", photo: "9a58aa7ded7d1a91ac6d14186862fd6eb8154ef2.png", photoSource: "local", flag: FLAG_MAP["NZ"], countryCode: "NZ", type: "Solo", since: 2019 },
  { id: "kai-sundara", name: "Kai Sundara", photo: "c4944ac0eb6e3448667d2151bb45addb90cb4f2a.png", photoSource: "local", flag: FLAG_MAP["JP"], countryCode: "JP", type: "Solo", since: 2017 },
  { id: "lena-voss", name: "Lena Voss", photo: "993d172c52b9d3dcf3f0a506889ca9ee1b98169a.png", photoSource: "local", flag: FLAG_MAP["SE"], countryCode: "SE", type: "Solo", since: 2012 },
  { id: "mara-soleil", name: "Mara Soleil", photo: "2fcb7d2b73fa1bac64a1a12f435c7d53564e0433.png", photoSource: "local", flag: FLAG_MAP["FR"], countryCode: "FR", type: "Solo", since: 2014 },
  { id: "nadia-fontaine", name: "Nadia Fontaine", photo: "0bbc6cf4c33b820e6a8259e508d898ce6af7597c.png", photoSource: "local", flag: FLAG_MAP["BE"], countryCode: "BE", type: "Solo", since: 2016 },
  { id: "neon-veins", name: "Neon Veins", photo: "cac58f2f9842578a4d678b01143de169f5e4bbe7.png", photoSource: "local", flag: FLAG_MAP["US"], countryCode: "US", type: "Group", groupSize: 4, since: 2008 },
  { id: "orbit-black", name: "Orbit Black", photo: "e8686cd93013af7d89c3cd75264c06fd216f5dfb.png", photoSource: "local", flag: FLAG_MAP["US"], countryCode: "US", type: "Group", groupSize: 5, since: 2015 },
  { id: "priya-menon", name: "Priya Menon", photo: "aaadbd21068b4ba721ad5e49cda6227ae233c005.png", photoSource: "local", flag: FLAG_MAP["IN"], countryCode: "IN", type: "Solo", since: 2019 },
  { id: "pulsar-twins", name: "Pulsar Twins", photo: "25ab3fea7da6bc0c54477203bf94da14f6ae7545.png", photoSource: "local", flag: FLAG_MAP["US"], countryCode: "US", type: "Group", groupSize: 2, since: 2016 },
  { id: "rafael-dumont", name: "Rafael Dumont", photo: "6e3c37d1683036b8bc5d43e96b57e4bb686c7574.png", photoSource: "local", flag: FLAG_MAP["BR"], countryCode: "BR", type: "Solo", since: 2011 },
  { id: "soren-holt", name: "Soren Holt", photo: "922ad3553e61c4ce50459b8f56e58c0ccff2eed4.png", photoSource: "local", flag: FLAG_MAP["DK"], countryCode: "DK", type: "Solo", since: 2019 },
  { id: "static-empire", name: "Static Empire", photo: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", photoSource: "local", flag: FLAG_MAP["CA"], countryCode: "CA", type: "Group", groupSize: 6, since: 2003 },
  { id: "the-amber-circuit", name: "The Amber Circuit", photo: "59e7a155c17e2b84ddb3cf338f6db93aa9acdb05.png", photoSource: "local", flag: FLAG_MAP["NL"], countryCode: "NL", type: "Group", groupSize: 3, since: 2009 },
  { id: "the-drift-collective", name: "The Drift Collective", photo: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", photoSource: "local", flag: FLAG_MAP["UK"], countryCode: "UK", type: "Group", groupSize: 5, since: 2005 },
  { id: "the-glass-menagerie", name: "The Glass Menagerie", photo: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", photoSource: "local", flag: FLAG_MAP["UK"], countryCode: "UK", type: "Group", groupSize: 4, since: 2004 },
  { id: "the-iron-shore", name: "The Iron Shore", photo: "e82d9688a856fe72c9b03c31786359da69317a35.png", photoSource: "local", flag: FLAG_MAP["IE"], countryCode: "IE", type: "Group", groupSize: 3, since: 2009 },
  { id: "the-lunar-wolves", name: "The Lunar Wolves", photo: "6192ec3cb5df7f5cd90e54ab9d6ca430fddc3a7b.png", photoSource: "local", flag: FLAG_MAP["AU"], countryCode: "AU", type: "Group", groupSize: 4, since: 2007 },
  { id: "the-salt-flats", name: "The Salt Flats", photo: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", photoSource: "local", flag: FLAG_MAP["CA"], countryCode: "CA", type: "Group", groupSize: 5, since: 2011 },
  { id: "tomas-reyes", name: "Tomas Reyes", photo: "c6de21dc8d5456ac2ebb4baa69acae9abfd6bd71.png", photoSource: "local", flag: FLAG_MAP["MX"], countryCode: "MX", type: "Solo", since: 2009 },
  { id: "void-signal", name: "Void Signal", photo: "8934c094ec0252fdf8bc4f8dc921d9ccfa26e952.png", photoSource: "local", flag: FLAG_MAP["KR"], countryCode: "KR", type: "Group", groupSize: 7, since: 2016 },
  { id: "yara-osei", name: "Yara Osei", photo: "d055eff3014753f8cf2064305b7581c6999e88be.png", photoSource: "local", flag: FLAG_MAP["GH"], countryCode: "GH", type: "Solo", since: 2020 },
  { id: "zuri-nakamura", name: "Zuri Nakamura", photo: "7904cb0025b39f222fadb1ef662026d6f6865817.png", photoSource: "local", flag: FLAG_MAP["US"], countryCode: "US", type: "Solo", since: 2012 },
];

const INITIAL_ALBUMS: Album[] = [
  { id: "debut", title: "Debut", artistId: "cleo-sterling", artistName: "Cleo Sterling", artistPhoto: "629591e353030fa597f22547cf5a231c2df4ca33.png", label: "Wavefront Music", year: 2021, sold: "85K", tracks: 6, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgDebut },
  { id: "amber-hours", title: "Amber Hours", artistId: "cleo-sterling", artistName: "Cleo Sterling", artistPhoto: "629591e353030fa597f22547cf5a231c2df4ca33.png", label: "Wavefront Music", year: 2023, sold: "62K", tracks: 8, singles: 2, cert: null, streaming: ["SP"], cover: imgAmberHours },
  { id: "dark-matter", title: "Dark Matter", artistId: "crimson-atlas", artistName: "Crimson Atlas", artistPhoto: "3d50ead32c01ecb5b47119643b3ecca40f989248.png", label: "Fracture Records", year: 2014, sold: "340K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP"], cover: imgDarkMatter },
  { id: "bifurcation-point", title: "Bifurcation Point", artistId: "crimson-atlas", artistName: "Crimson Atlas", artistPhoto: "3d50ead32c01ecb5b47119643b3ecca40f989248.png", label: "Fracture Records", year: 2016, sold: "680K", tracks: 13, singles: 4, cert: "Platinum", streaming: ["SP", "AM"], cover: imgBifurcationPoint },
  { id: "collapse-theory", title: "Collapse Theory", artistId: "crimson-atlas", artistName: "Crimson Atlas", artistPhoto: "3d50ead32c01ecb5b47119643b3ecca40f989248.png", label: "Fracture Records", year: 2018, sold: "720K", tracks: 12, singles: 3, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgCollapseTheory },
  { id: "crystal-lattice", title: "Crystal Lattice", artistId: "crimson-atlas", artistName: "Crimson Atlas", artistPhoto: "3d50ead32c01ecb5b47119643b3ecca40f989248.png", label: "Fracture Records", year: 2021, sold: "480K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgCrystalLattice },
  { id: "kruger-sessions", title: "Kruger Sessions", artistId: "deep-current", artistName: "Deep Current", artistPhoto: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", label: "Indaba Studios", year: 2010, sold: "380K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgKrugerSessions },
  { id: "cape-town-frequencies", title: "Cape Town Frequencies", artistId: "deep-current", artistName: "Deep Current", artistPhoto: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", label: "Indaba Studios", year: 2013, sold: "540K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgCapeTownFrequencies },
  { id: "indlela", title: "Indlela", artistId: "deep-current", artistName: "Deep Current", artistPhoto: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", label: "Indaba Studios", year: 2016, sold: "290K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AZ"], cover: imgIndlela },
  { id: "signal-decay", title: "Signal Decay", artistId: "deep-current", artistName: "Deep Current", artistPhoto: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", label: "Indaba Studios", year: 2018, sold: "360K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgSignalDecay },
  { id: "shoreline-hymns", title: "Shoreline Hymns", artistId: "deep-current", artistName: "Deep Current", artistPhoto: "74cbb3469032b1458d4a61826025a00fc39bb1cf.png", label: "Indaba Studios", year: 2020, sold: "410K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgShorelineHymns },
  { id: "resonanzfeld", title: "Resonanzfeld", artistId: "dmitri-volkov", artistName: "Dmitri Volkov", artistPhoto: "840b1445a965dde9c17ff977f5e596285dd0af2c.png", label: "Siberian Sound", year: 2013, sold: "570K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgResonanzfeld },
  { id: "ghost-frequencies", title: "Ghost Frequencies", artistId: "dmitri-volkov", artistName: "Dmitri Volkov", artistPhoto: "840b1445a965dde9c17ff977f5e596285dd0af2c.png", label: "Siberian Sound", year: 2016, sold: "480K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgGhostFrequencies },
  { id: "dark-side-frequencies", title: "Dark Side Frequencies", artistId: "dmitri-volkov", artistName: "Dmitri Volkov", artistPhoto: "840b1445a965dde9c17ff977f5e596285dd0af2c.png", label: "Siberian Sound", year: 2019, sold: "380K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgDarkSideFrequencies },
  { id: "feedback-loop", title: "Feedback Loop", artistId: "dmitri-volkov", artistName: "Dmitri Volkov", artistPhoto: "840b1445a965dde9c17ff977f5e596285dd0af2c.png", label: "Siberian Sound", year: 2022, sold: "215K", tracks: 8, singles: 2, cert: null, streaming: ["SP"], cover: imgFeedbackLoop },
  { id: "iteration-zero", title: "Iteration Zero", artistId: "echo-assembly", artistName: "Echo Assembly", artistPhoto: "fd9e78c0d36b29e95d78bc0061110af5925b95bb.png", label: "Neon Factory", year: 2010, sold: "450K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgIterationZero },
  { id: "mandelbrot-suite", title: "Mandelbrot Suite", artistId: "echo-assembly", artistName: "Echo Assembly", artistPhoto: "fd9e78c0d36b29e95d78bc0061110af5925b95bb.png", label: "Neon Factory", year: 2015, sold: "560K", tracks: 13, singles: 4, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgMandelbrotSuite },
  { id: "binary-star", title: "Binary Star", artistId: "echo-assembly", artistName: "Echo Assembly", artistPhoto: "fd9e78c0d36b29e95d78bc0061110af5925b95bb.png", label: "Neon Factory", year: 2019, sold: "290K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgBinaryStar },
  { id: "exoplanet", title: "Exoplanet", artistId: "echo-assembly", artistName: "Echo Assembly", artistPhoto: "fd9e78c0d36b29e95d78bc0061110af5925b95bb.png", label: "Neon Factory", year: 2023, sold: "145K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgExoplanet },
  { id: "horizon-dore", title: "Horizon Doré", artistId: "elara-vind", artistName: "Elara Vind", artistPhoto: "f57af44522dcfc86b6bd37afc67442c47b22ed45.png", label: "Fjord Music", year: 2013, sold: "520K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgHorizonDore },
  { id: "eclats", title: "Éclats", artistId: "elara-vind", artistName: "Elara Vind", artistPhoto: "f57af44522dcfc86b6bd37afc67442c47b22ed45.png", label: "Fjord Music", year: 2016, sold: "430K", tracks: 10, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgEclats },
  { id: "featherweight", title: "Featherweight", artistId: "elara-vind", artistName: "Elara Vind", artistPhoto: "f57af44522dcfc86b6bd37afc67442c47b22ed45.png", label: "Fjord Music", year: 2020, sold: "290K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgFeatherweight },
  { id: "bruges-nocturne", title: "Bruges Nocturne", artistId: "elara-vind", artistName: "Elara Vind", artistPhoto: "f57af44522dcfc86b6bd37afc67442c47b22ed45.png", label: "Fjord Music", year: 2022, sold: "160K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgBrugesNocturne },
  { id: "wingspan", title: "Wingspan", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2017, sold: "220K", tracks: 10, singles: 1, cert: null, streaming: ["SP"], cover: imgWingspan },
  { id: "chromatic-pulse", title: "Chromatic Pulse", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2018, sold: "410K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgChromaticPulse },
  { id: "voltage-dreams", title: "Voltage Dreams", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2020, sold: "290K", tracks: 9, singles: 2, cert: null, streaming: ["AM"], cover: imgVoltageDreams },
  { id: "indigo-frequencies", title: "Indigo Frequencies", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2021, sold: "310K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgIndigoFrequencies },
  { id: "storm-season", title: "Storm Season", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2022, sold: "250K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgStormSeason },
  { id: "current-affairs", title: "Current Affairs", artistId: "fractal-dawn", artistName: "Fractal Dawn", artistPhoto: "9db23c15a2487b4f4592608380e712c7d8ede527.png", label: "Neon Factory", year: 2023, sold: "190K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgCurrentAffairs },
  { id: "cherry-blossom-static", title: "Cherry Blossom Static", artistId: "hana-mizuki", artistName: "Hana Mizuki", artistPhoto: "26d1caa7ae5d95a76994d531f9e7cd874ede70c2.png", label: "Sakura Collective", year: 2018, sold: "350K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgCherryBlossomStatic },
  { id: "paper-lanterns", title: "Paper Lanterns", artistId: "hana-mizuki", artistName: "Hana Mizuki", artistPhoto: "26d1caa7ae5d95a76994d531f9e7cd874ede70c2.png", label: "Sakura Collective", year: 2020, sold: "280K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgPaperLanterns },
  { id: "mineral-songs", title: "Mineral Songs", artistId: "hana-mizuki", artistName: "Hana Mizuki", artistPhoto: "26d1caa7ae5d95a76994d531f9e7cd874ede70c2.png", label: "Sakura Collective", year: 2023, sold: "120K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgMineralSongs },
  { id: "sea-glass", title: "Sea Glass", artistId: "isla-crane", artistName: "Isla Crane", artistPhoto: "9a58aa7ded7d1a91ac6d14186862fd6eb8154ef2.png", label: "Southern Cross", year: 2019, sold: "155K", tracks: 8, singles: 1, cert: null, streaming: ["SP"], cover: imgSeaGlass },
  { id: "crescent-tide", title: "Crescent Tide", artistId: "isla-crane", artistName: "Isla Crane", artistPhoto: "9a58aa7ded7d1a91ac6d14186862fd6eb8154ef2.png", label: "Southern Cross", year: 2021, sold: "210K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgCrescentTide },
  { id: "fragile-architecture", title: "Fragile Architecture", artistId: "isla-crane", artistName: "Isla Crane", artistPhoto: "9a58aa7ded7d1a91ac6d14186862fd6eb8154ef2.png", label: "Southern Cross", year: 2023, sold: "95K", tracks: 7, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgFragileArchitecture },
  { id: "archipelago", title: "Archipelago", artistId: "kai-sundara", artistName: "Kai Sundara", artistPhoto: "c4944ac0eb6e3448667d2151bb45addb90cb4f2a.png", label: "Desert Wave Records", year: 2017, sold: "320K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgArchipelago },
  { id: "alkali-dreams", title: "Alkali Dreams", artistId: "kai-sundara", artistName: "Kai Sundara", artistPhoto: "c4944ac0eb6e3448667d2151bb45addb90cb4f2a.png", label: "Desert Wave Records", year: 2019, sold: "260K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AZ"], cover: imgAlkaliDreams },
  { id: "echo-chamber", title: "Echo Chamber", artistId: "kai-sundara", artistName: "Kai Sundara", artistPhoto: "c4944ac0eb6e3448667d2151bb45addb90cb4f2a.png", label: "Desert Wave Records", year: 2022, sold: "180K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgEchoChamber },
  { id: "fjordlight", title: "Fjordlight", artistId: "lena-voss", artistName: "Lena Voss", artistPhoto: "993d172c52b9d3dcf3f0a506889ca9ee1b98169a.png", label: "Nordic Arc", year: 2013, sold: "490K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgFjordlight },
  { id: "white-noise-winter", title: "White Noise Winter", artistId: "lena-voss", artistName: "Lena Voss", artistPhoto: "993d172c52b9d3dcf3f0a506889ca9ee1b98169a.png", label: "Nordic Arc", year: 2016, sold: "920K", tracks: 11, singles: 3, cert: "Platinum", streaming: ["SP", "AM"], cover: imgWhiteNoiseWinter },
  { id: "solstice", title: "Solstice", artistId: "lena-voss", artistName: "Lena Voss", artistPhoto: "993d172c52b9d3dcf3f0a506889ca9ee1b98169a.png", label: "Nordic Arc", year: 2019, sold: "640K", tracks: 9, singles: 2, cert: "Gold", streaming: ["SP", "AZ"], cover: imgSolstice },
  { id: "aurora-borealis-ep", title: "Aurora Borealis EP", artistId: "lena-voss", artistName: "Lena Voss", artistPhoto: "993d172c52b9d3dcf3f0a506889ca9ee1b98169a.png", label: "Nordic Arc", year: 2021, sold: "280K", tracks: 6, singles: 0, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgAuroraBorealisEp },
  { id: "premiere-lumiere", title: "Première Lumière", artistId: "mara-soleil", artistName: "Mara Soleil", artistPhoto: "2fcb7d2b73fa1bac64a1a12f435c7d53564e0433.png", label: "Atlantic Sound", year: 2014, sold: "610K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgPremiereLumiere },
  { id: "beira-mar", title: "Beira Mar", artistId: "mara-soleil", artistName: "Mara Soleil", artistPhoto: "2fcb7d2b73fa1bac64a1a12f435c7d53564e0433.png", label: "Atlantic Sound", year: 2017, sold: "520K", tracks: 10, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgBeiraMar },
  { id: "seven-rivers", title: "Seven Rivers", artistId: "mara-soleil", artistName: "Mara Soleil", artistPhoto: "2fcb7d2b73fa1bac64a1a12f435c7d53564e0433.png", label: "Atlantic Sound", year: 2019, sold: "320K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgSevenRivers },
  { id: "chocolate-box", title: "Chocolate Box", artistId: "mara-soleil", artistName: "Mara Soleil", artistPhoto: "2fcb7d2b73fa1bac64a1a12f435c7d53564e0433.png", label: "Atlantic Sound", year: 2022, sold: "240K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgChocolateBox },
  { id: "meridian", title: "Meridian", artistId: "nadia-fontaine", artistName: "Nadia Fontaine", artistPhoto: "0bbc6cf4c33b820e6a8259e508d898ce6af7597c.png", label: "Crescent Records", year: 2016, sold: "340K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgMeridian },
  { id: "ultraviolet", title: "Ultraviolet", artistId: "nadia-fontaine", artistName: "Nadia Fontaine", artistPhoto: "0bbc6cf4c33b820e6a8259e508d898ce6af7597c.png", label: "Crescent Records", year: 2019, sold: "410K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgUltraviolet },
  { id: "refraction", title: "Refraction", artistId: "nadia-fontaine", artistName: "Nadia Fontaine", artistPhoto: "0bbc6cf4c33b820e6a8259e508d898ce6af7597c.png", label: "Crescent Records", year: 2022, sold: "180K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgRefraction },
  { id: "empire-state-of-bass", title: "Empire State of Bass", artistId: "neon-veins", artistName: "Neon Veins", artistPhoto: "cac58f2f9842578a4d678b01143de169f5e4bbe7.png", label: "Electric South", year: 2012, sold: "760K", tracks: 14, singles: 5, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgEmpireStateOfBass },
  { id: "howl-at-apogee", title: "Howl at Apogee", artistId: "neon-veins", artistName: "Neon Veins", artistPhoto: "cac58f2f9842578a4d678b01143de169f5e4bbe7.png", label: "Electric South", year: 2015, sold: "580K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM"], cover: imgHowlAtApogee },
  { id: "event-horizon-ii", title: "Event Horizon II", artistId: "neon-veins", artistName: "Neon Veins", artistPhoto: "cac58f2f9842578a4d678b01143de169f5e4bbe7.png", label: "Electric South", year: 2018, sold: "430K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AZ"], cover: imgEventHorizonIi },
  { id: "badlands-hymnal", title: "Badlands Hymnal", artistId: "orbit-black", artistName: "Orbit Black", artistPhoto: "e8686cd93013af7d89c3cd75264c06fd216f5dfb.png", label: "Crossroads Music", year: 2015, sold: "290K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AZ"], cover: imgBadlandsHymnal },
  { id: "ciudad-fantasma", title: "Ciudad Fantasma", artistId: "orbit-black", artistName: "Orbit Black", artistPhoto: "e8686cd93013af7d89c3cd75264c06fd216f5dfb.png", label: "Crossroads Music", year: 2018, sold: "380K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgCiudadFantasma },
  { id: "frontera", title: "Frontera", artistId: "orbit-black", artistName: "Orbit Black", artistPhoto: "e8686cd93013af7d89c3cd75264c06fd216f5dfb.png", label: "Crossroads Music", year: 2021, sold: "420K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgFrontera },
  { id: "basalt", title: "Basalt", artistId: "priya-menon", artistName: "Priya Menon", artistPhoto: "aaadbd21068b4ba721ad5e49cda6227ae233c005.png", label: "Monsoon Label", year: 2019, sold: "140K", tracks: 7, singles: 1, cert: null, streaming: ["SP"], cover: imgBasalt },
  { id: "andes-transmission", title: "Andes Transmission", artistId: "priya-menon", artistName: "Priya Menon", artistPhoto: "aaadbd21068b4ba721ad5e49cda6227ae233c005.png", label: "Monsoon Label", year: 2021, sold: "210K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgAndesTransmission },
  { id: "dark-matter-pt", title: "Dark Matter", artistId: "pulsar-twins", artistName: "Pulsar Twins", artistPhoto: "25ab3fea7da6bc0c54477203bf94da14f6ae7545.png", label: "Twin Axis", year: 2016, sold: "340K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgDarkMatter },
  { id: "bifurcation-pt", title: "Bifurcation", artistId: "pulsar-twins", artistName: "Pulsar Twins", artistPhoto: "25ab3fea7da6bc0c54477203bf94da14f6ae7545.png", label: "Twin Axis", year: 2019, sold: "280K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgBifurcationPoint },
  { id: "event-horizon-pt", title: "Event Horizon", artistId: "pulsar-twins", artistName: "Pulsar Twins", artistPhoto: "25ab3fea7da6bc0c54477203bf94da14f6ae7545.png", label: "Twin Axis", year: 2022, sold: "190K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgEventHorizonIi },
  { id: "horizonte-rojo-tr", title: "Horizonte Rojo", artistId: "tomas-reyes", artistName: "Tomas Reyes", artistPhoto: "c6de21dc8d5456ac2ebb4baa69acae9abfd6bd71.png", label: "Maguey Sonido", year: 2009, sold: "390K", tracks: 10, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgHorizonteRojo },
  { id: "eclats-tr", title: "Éclats", artistId: "tomas-reyes", artistName: "Tomas Reyes", artistPhoto: "c6de21dc8d5456ac2ebb4baa69acae9abfd6bd71.png", label: "Maguey Sonido", year: 2013, sold: "290K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgEclats },
  { id: "bruges-tr", title: "Nocturno", artistId: "tomas-reyes", artistName: "Tomas Reyes", artistPhoto: "c6de21dc8d5456ac2ebb4baa69acae9abfd6bd71.png", label: "Maguey Sonido", year: 2017, sold: "350K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgBrugesNocturne },
  { id: "premiere-tr", title: "Primera Luz", artistId: "tomas-reyes", artistName: "Tomas Reyes", artistPhoto: "c6de21dc8d5456ac2ebb4baa69acae9abfd6bd71.png", label: "Maguey Sonido", year: 2022, sold: "240K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgPremiereLumiere },
  { id: "horizonte-rojo-rd", title: "Horizonte Rojo", artistId: "rafael-dumont", artistName: "Rafael Dumont", artistPhoto: "6e3c37d1683036b8bc5d43e96b57e4bb686c7574.png", label: "Maguey Sonido", year: 2014, sold: "390K", tracks: 10, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgHorizonteRojo },
  { id: "beira-mar-rd", title: "Beira Mar", artistId: "rafael-dumont", artistName: "Rafael Dumont", artistPhoto: "6e3c37d1683036b8bc5d43e96b57e4bb686c7574.png", label: "Maguey Sonido", year: 2017, sold: "310K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgBeiraMar },
  { id: "dissolucao", title: "Dissolução", artistId: "rafael-dumont", artistName: "Rafael Dumont", artistPhoto: "6e3c37d1683036b8bc5d43e96b57e4bb686c7574.png", label: "Maguey Sonido", year: 2020, sold: "240K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgCollapseTheory },
  { id: "sete-rios", title: "Sete Rios", artistId: "rafael-dumont", artistName: "Rafael Dumont", artistPhoto: "6e3c37d1683036b8bc5d43e96b57e4bb686c7574.png", label: "Maguey Sonido", year: 2023, sold: "145K", tracks: 8, singles: 1, cert: null, streaming: ["SP"], cover: imgSevenRivers },
  { id: "storm-season-sh", title: "Storm Season", artistId: "soren-holt", artistName: "Soren Holt", artistPhoto: "922ad3553e61c4ce50459b8f56e58c0ccff2eed4.png", label: "Nordic Sound", year: 2019, sold: "180K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgStormSeason },
  { id: "wingspan-sh", title: "Wingspan", artistId: "soren-holt", artistName: "Soren Holt", artistPhoto: "922ad3553e61c4ce50459b8f56e58c0ccff2eed4.png", label: "Nordic Sound", year: 2021, sold: "240K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgWingspan },
  { id: "featherweight-sh", title: "Featherweight", artistId: "soren-holt", artistName: "Soren Holt", artistPhoto: "922ad3553e61c4ce50459b8f56e58c0ccff2eed4.png", label: "Nordic Sound", year: 2023, sold: "120K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgFeatherweight },
  { id: "current-affairs-se", title: "Current Affairs", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2003, sold: "240K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgCurrentAffairs },
  { id: "signal-decay-se", title: "Signal Decay", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2007, sold: "380K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgSignalDecay },
  { id: "feedback-loop-se", title: "Feedback Loop", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2011, sold: "520K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgFeedbackLoop },
  { id: "chromatic-pulse-se", title: "Chromatic Pulse", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2015, sold: "680K", tracks: 13, singles: 5, cert: "Platinum", streaming: ["SP", "AM"], cover: imgChromaticPulse },
  { id: "dark-side-se", title: "Dark Side", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2019, sold: "440K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgDarkSideFrequencies },
  { id: "voltage-dreams-se", title: "Voltage Dreams", artistId: "static-empire", artistName: "Static Empire", artistPhoto: "6458070e3dffac539b4ff55eef6b17c40efee6e5.png", label: "Amplify CA", year: 2023, sold: "210K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgVoltageDreams },
  { id: "refraction-tac", title: "Refraction", artistId: "the-amber-circuit", artistName: "The Amber Circuit", artistPhoto: "59e7a155c17e2b84ddb3cf338f6db93aa9acdb05.png", label: "Circuit Press", year: 2009, sold: "290K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgRefraction },
  { id: "resonanzfeld-tac", title: "Resonanzfeld", artistId: "the-amber-circuit", artistName: "The Amber Circuit", artistPhoto: "59e7a155c17e2b84ddb3cf338f6db93aa9acdb05.png", label: "Circuit Press", year: 2013, sold: "410K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgResonanzfeld },
  { id: "indigo-frequencies-tac", title: "Indigo Frequencies", artistId: "the-amber-circuit", artistName: "The Amber Circuit", artistPhoto: "59e7a155c17e2b84ddb3cf338f6db93aa9acdb05.png", label: "Circuit Press", year: 2017, sold: "350K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgIndigoFrequencies },
  { id: "ultraviolet-tac", title: "Ultraviolet", artistId: "the-amber-circuit", artistName: "The Amber Circuit", artistPhoto: "59e7a155c17e2b84ddb3cf338f6db93aa9acdb05.png", label: "Circuit Press", year: 2022, sold: "180K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgUltraviolet },
  { id: "dark-side-tdc", title: "Dark Side Frequencies", artistId: "the-drift-collective", artistName: "The Drift Collective", artistPhoto: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", label: "Northern Drift", year: 2005, sold: "190K", tracks: 10, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgDarkSideFrequencies },
  { id: "collapse-theory-tdc", title: "Collapse Theory", artistId: "the-drift-collective", artistName: "The Drift Collective", artistPhoto: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", label: "Northern Drift", year: 2009, sold: "340K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgCollapseTheory },
  { id: "echo-chamber-tdc", title: "Echo Chamber", artistId: "the-drift-collective", artistName: "The Drift Collective", artistPhoto: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", label: "Northern Drift", year: 2013, sold: "480K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgEchoChamber },
  { id: "signal-decay-tdc", title: "Signal Decay", artistId: "the-drift-collective", artistName: "The Drift Collective", artistPhoto: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", label: "Northern Drift", year: 2017, sold: "560K", tracks: 13, singles: 4, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgSignalDecay },
  { id: "voltage-dreams-tdc", title: "Voltage Dreams", artistId: "the-drift-collective", artistName: "The Drift Collective", artistPhoto: "094e2ce1501f135cfd75e7191a869bdc7be20cba.png", label: "Northern Drift", year: 2021, sold: "320K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgVoltageDreams },
  { id: "mandelbrot-tgm", title: "Mandelbrot Suite", artistId: "the-glass-menagerie", artistName: "The Glass Menagerie", artistPhoto: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", label: "Glass Press", year: 2004, sold: "240K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgMandelbrotSuite },
  { id: "fragile-architecture-tgm", title: "Fragile Architecture", artistId: "the-glass-menagerie", artistName: "The Glass Menagerie", artistPhoto: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", label: "Glass Press", year: 2008, sold: "380K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgFragileArchitecture },
  { id: "crystal-lattice-tgm", title: "Crystal Lattice", artistId: "the-glass-menagerie", artistName: "The Glass Menagerie", artistPhoto: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", label: "Glass Press", year: 2012, sold: "520K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgCrystalLattice },
  { id: "archipelago-tgm", title: "Archipelago", artistId: "the-glass-menagerie", artistName: "The Glass Menagerie", artistPhoto: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", label: "Glass Press", year: 2016, sold: "440K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgArchipelago },
  { id: "binary-star-tgm", title: "Binary Star", artistId: "the-glass-menagerie", artistName: "The Glass Menagerie", artistPhoto: "867faa1004bba9988647907cceacbfd8b4fb16ba.png", label: "Glass Press", year: 2021, sold: "290K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgBinaryStar },
  { id: "howl-tis", title: "Howl at Apogee", artistId: "the-iron-shore", artistName: "The Iron Shore", artistPhoto: "e82d9688a856fe72c9b03c31786359da69317a35.png", label: "Atlantic Shore", year: 2009, sold: "280K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgHowlAtApogee },
  { id: "shoreline-tis", title: "Shoreline Hymns", artistId: "the-iron-shore", artistName: "The Iron Shore", artistPhoto: "e82d9688a856fe72c9b03c31786359da69317a35.png", label: "Atlantic Shore", year: 2012, sold: "390K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgShorelineHymns },
  { id: "event-horizon-tis", title: "Event Horizon", artistId: "the-iron-shore", artistName: "The Iron Shore", artistPhoto: "e82d9688a856fe72c9b03c31786359da69317a35.png", label: "Atlantic Shore", year: 2015, sold: "510K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM"], cover: imgEventHorizonIi },
  { id: "sea-glass-tis", title: "Sea Glass", artistId: "the-iron-shore", artistName: "The Iron Shore", artistPhoto: "e82d9688a856fe72c9b03c31786359da69317a35.png", label: "Atlantic Shore", year: 2018, sold: "350K", tracks: 10, singles: 2, cert: "Gold", streaming: ["SP", "AZ"], cover: imgSeaGlass },
  { id: "crescent-tis", title: "Crescent Tide", artistId: "the-iron-shore", artistName: "The Iron Shore", artistPhoto: "e82d9688a856fe72c9b03c31786359da69317a35.png", label: "Atlantic Shore", year: 2022, sold: "210K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgCrescentTide },
  { id: "howl-tlw", title: "Howl", artistId: "the-lunar-wolves", artistName: "The Lunar Wolves", artistPhoto: "6192ec3cb5df7f5cd90e54ab9d6ca430fddc3a7b.png", label: "Full Moon Records", year: 2007, sold: "310K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgHowlAtApogee },
  { id: "dark-matter-tlw", title: "Dark Matter", artistId: "the-lunar-wolves", artistName: "The Lunar Wolves", artistPhoto: "6192ec3cb5df7f5cd90e54ab9d6ca430fddc3a7b.png", label: "Full Moon Records", year: 2011, sold: "450K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgDarkMatter },
  { id: "storm-season-tlw", title: "Storm Season", artistId: "the-lunar-wolves", artistName: "The Lunar Wolves", artistPhoto: "6192ec3cb5df7f5cd90e54ab9d6ca430fddc3a7b.png", label: "Full Moon Records", year: 2015, sold: "580K", tracks: 13, singles: 4, cert: "Platinum", streaming: ["SP", "AM", "AZ"], cover: imgStormSeason },
  { id: "mineral-songs-tlw", title: "Mineral Songs", artistId: "the-lunar-wolves", artistName: "The Lunar Wolves", artistPhoto: "6192ec3cb5df7f5cd90e54ab9d6ca430fddc3a7b.png", label: "Full Moon Records", year: 2020, sold: "370K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM"], cover: imgMineralSongs },
  { id: "basalt-tsf", title: "Basalt", artistId: "the-salt-flats", artistName: "The Salt Flats", artistPhoto: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", label: "Desert Press", year: 2011, sold: "220K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgBasalt },
  { id: "alkali-dreams-tsf", title: "Alkali Dreams", artistId: "the-salt-flats", artistName: "The Salt Flats", artistPhoto: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", label: "Desert Press", year: 2014, sold: "340K", tracks: 11, singles: 2, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgAlkaliDreams },
  { id: "ciudad-tsf", title: "Ciudad Fantasma", artistId: "the-salt-flats", artistName: "The Salt Flats", artistPhoto: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", label: "Desert Press", year: 2017, sold: "420K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM"], cover: imgCiudadFantasma },
  { id: "frontera-tsf", title: "Frontera", artistId: "the-salt-flats", artistName: "The Salt Flats", artistPhoto: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", label: "Desert Press", year: 2020, sold: "310K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgFrontera },
  { id: "horizonte-tsf", title: "Horizonte Rojo", artistId: "the-salt-flats", artistName: "The Salt Flats", artistPhoto: "6d14be70514586051a7d60189ae4f68f5e51ca48.png", label: "Desert Press", year: 2023, sold: "180K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgHorizonteRojo },
  { id: "iteration-zero-vs", title: "Iteration Zero", artistId: "void-signal", artistName: "Void Signal", artistPhoto: "8934c094ec0252fdf8bc4f8dc921d9ccfa26e952.png", label: "Seoul Wave", year: 2016, sold: "280K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgIterationZero },
  { id: "binary-star-vs", title: "Binary Star", artistId: "void-signal", artistName: "Void Signal", artistPhoto: "8934c094ec0252fdf8bc4f8dc921d9ccfa26e952.png", label: "Seoul Wave", year: 2018, sold: "390K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgBinaryStar },
  { id: "collapse-theory-vs", title: "Collapse Theory", artistId: "void-signal", artistName: "Void Signal", artistPhoto: "8934c094ec0252fdf8bc4f8dc921d9ccfa26e952.png", label: "Seoul Wave", year: 2021, sold: "510K", tracks: 12, singles: 4, cert: "Platinum", streaming: ["SP", "AM"], cover: imgCollapseTheory },
  { id: "exoplanet-vs", title: "Exoplanet", artistId: "void-signal", artistName: "Void Signal", artistPhoto: "8934c094ec0252fdf8bc4f8dc921d9ccfa26e952.png", label: "Seoul Wave", year: 2023, sold: "220K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgExoplanet },
  { id: "indlela-yo", title: "Indlela", artistId: "yara-osei", artistName: "Yara Osei", artistPhoto: "d055eff3014753f8cf2064305b7581c6999e88be.png", label: "Accra Rising", year: 2020, sold: "145K", tracks: 8, singles: 1, cert: null, streaming: ["SP", "AM"], cover: imgIndlela },
  { id: "cape-town-yo", title: "Cape Town Frequencies", artistId: "yara-osei", artistName: "Yara Osei", artistPhoto: "d055eff3014753f8cf2064305b7581c6999e88be.png", label: "Accra Rising", year: 2022, sold: "190K", tracks: 9, singles: 2, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgCapeTownFrequencies },
  { id: "empire-state-zn", title: "Empire State of Bass", artistId: "zuri-nakamura", artistName: "Zuri Nakamura", artistPhoto: "7904cb0025b39f222fadb1ef662026d6f6865817.png", label: "Nakamura Music", year: 2012, sold: "480K", tracks: 12, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgEmpireStateOfBass },
  { id: "echo-chamber-zn", title: "Echo Chamber", artistId: "zuri-nakamura", artistName: "Zuri Nakamura", artistPhoto: "7904cb0025b39f222fadb1ef662026d6f6865817.png", label: "Nakamura Music", year: 2015, sold: "590K", tracks: 13, singles: 4, cert: "Platinum", streaming: ["SP", "AM"], cover: imgEchoChamber },
  { id: "ultraviolet-zn", title: "Ultraviolet", artistId: "zuri-nakamura", artistName: "Zuri Nakamura", artistPhoto: "7904cb0025b39f222fadb1ef662026d6f6865817.png", label: "Nakamura Music", year: 2018, sold: "430K", tracks: 11, singles: 3, cert: "Gold", streaming: ["SP", "AM", "AZ"], cover: imgUltraviolet },
  { id: "dark-matter-zn", title: "Dark Matter", artistId: "zuri-nakamura", artistName: "Zuri Nakamura", artistPhoto: "7904cb0025b39f222fadb1ef662026d6f6865817.png", label: "Nakamura Music", year: 2021, sold: "310K", tracks: 10, singles: 2, cert: null, streaming: ["SP", "AM"], cover: imgDarkMatter },
  { id: "voltage-dreams-zn", title: "Voltage Dreams", artistId: "zuri-nakamura", artistName: "Zuri Nakamura", artistPhoto: "7904cb0025b39f222fadb1ef662026d6f6865817.png", label: "Nakamura Music", year: 2023, sold: "195K", tracks: 9, singles: 1, cert: null, streaming: ["SP", "AM", "AZ"], cover: imgVoltageDreams },
];
...
function ConfirmDialog({ title, body, confirmLabel = "Delete", image, imageShape = "square", avatarName, avatarPhotoSource, onConfirm, onCancel, isDark }: ConfirmDialogProps) {
        ...
        <div className="flex items-start gap-[28px] mt-[28px]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <button onClick={onGoToArtist} className="flex items-center gap-[7px] mt-[10.5px] group/artist hover:opacity-80 transition-opacity">
              <ArtistAvatar name={album.artistName} photo={album.artistPhoto} sizeClass="size-[42px]" isDark={isDark} />
...
export default function App() {
  ...
  const handleEditArtist = (updated: Artist) => {
    ...
    setAlbums((prev) =>
      prev.map((al) =>
        al.artistId === updated.id
          ? { ...al, artistName: updated.name, artistPhoto: updated.photo }
          : al
      )
    );
        ...
        {pendingDelete?.type === "artist" && (() => {
          ...
          return (
            <ConfirmDialog
              ...
              avatarPhotoSource={artist?.photoSource}
