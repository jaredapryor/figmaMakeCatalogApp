import svgPaths from "./svg-bdi7c1acon";
...
function Button3() {
  return (
    <div className="h-[17.5px] relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7px] items-center relative size-full">
        <Icon1 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[17.5px] not-italic relative shrink-0 text-[#7070a0] text-[12.25px] text-center whitespace-nowrap">Back to Artists</p>
      </div>
    </div>
  );
}
...
function ArtistAvatar() {
  return (
    <div className="bg-[#1a1a26] relative rounded-[26843500px] shrink-0 size-[168px]" data-name="ArtistAvatar">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Playfair_Display:Bold',sans-serif] font-bold leading-[31.5px] relative shrink-0 text-[#f2f2f8] text-[26.25px] whitespace-nowrap">Lena Voss</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="bg-[#1e1e2e] relative rounded-[26843500px] shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[7px] py-[1.75px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">Active since 2012</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[11px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g clipPath="url(#clip0_2_7184)" id="Icon">
          <path d={svgPaths.p1f658e00} id="Vector" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.916667" />
          <path d={svgPaths.p380021a0} id="Vector_2" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.916667" />
          <path d={svgPaths.p2bdf8500} id="Vector_3" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.916667" />
          <path d={svgPaths.paacc480} id="Vector_4" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.916667" />
        </g>
        <defs>
          <clipPath id="clip0_2_7184">
...
function Container5() {
  return (
    <div className="h-[28px] relative shrink-0 w-[517.55px]" data-name="Container">
...
function Container4() {
  return (
    <div className="flex-[518.588_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Heading />
        <Container5 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2_7190)" id="Icon">
          <path d={svgPaths.p27b3900} id="Vector" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M7.5 2.5L9.5 4.5" id="Vector_2" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2_7190">
  ...
  return (
    <div className="relative rounded-[10.5px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[5.25px] items-center px-[11.3px] py-[7.8px] relative size-full">
        <Icon3 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] text-center whitespace-nowrap">Edit Artist</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-[#13131c] relative rounded-[14px] shrink-0 w-full" data-name="Container">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M12 10L8 6L4 10" id="Vector" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button5() {
  return (
    <div className="relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7px] items-center relative size-full">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#f2f2f8] text-[14px] text-center whitespace-nowrap">Albums</p>
        <Icon4 />
      </div>
    </div>
  );
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icon">
          <path d="M2.5 6H9.5" id="Vector" stroke="var(--stroke-0, #A855F7)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M6 2.5V9.5" id="Vector_2" stroke="var(--stroke-0, #A855F7)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[rgba(168,85,247,0.2)] relative rounded-[10.5px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[5.25px] items-center px-[10.5px] py-[5.25px] relative size-full">
        <Icon5 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#a855f7] text-[10.5px] text-center whitespace-nowrap">Add Album</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[rgba(255,255,255,0.04)] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
...
function CoverImage() {
  return (
    <div className="bg-[#1a1a26] relative rounded-[10.5px] shrink-0 size-[56px]" data-name="CoverImage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <ImageFjordlight />
      </div>
    </div>
...
function Paragraph() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[17.5px] not-italic relative shrink-0 text-[#f2f2f8] text-[12.25px] whitespace-nowrap">Fjordlight</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.75px] relative shrink-0 w-[679.95px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.75px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">Nordic Arc · 2013</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">490K sold</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">·</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">10 tracks</p>
      </div>
    </div>
  );
}
...
function Button8() {
  return (
    <div className="relative rounded-[10.5px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border-[0.8px] border-[rgba(255,255,255,0.04)] border-solid inset-0 pointer-events-none rounded-[10.5px]" />
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icon">
          <path d="M1.5 3H10.5" id="Vector" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p3ba57a00} id="Vector_2" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p36919d00} id="Vector_3" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M5 5.5V8.5" id="Vector_4" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M7 5.5V8.5" id="Vector_5" stroke="var(--stroke-0, #7070A0)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Container9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[rgba(255,255,255,0.02)] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Paragraph2() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[17.5px] not-italic relative shrink-0 text-[#f2f2f8] text-[12.25px] whitespace-nowrap">White Noise Winter</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[679.95px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.75px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">Nordic Arc · 2016</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">920K sold</p>
      </div>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">11 tracks</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[17.5px] not-italic relative shrink-0 text-[#f2f2f8] text-[12.25px] whitespace-nowrap">Solstice</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[679.95px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.75px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">Nordic Arc · 2019</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">640K sold</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">9 tracks</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[17.5px] not-italic relative shrink-0 text-[#f2f2f8] text-[12.25px] whitespace-nowrap">Aurora Borealis EP</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[15.75px] relative shrink-0 w-[679.95px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[1.75px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">Nordic Arc · 2021</p>
      </div>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">280K sold</p>
      </div>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#7070a0] text-[10.5px] whitespace-nowrap">6 tracks</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="bg-[#13131c] h-[398.013px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
export default function ArtistDetail() {
  return (
    <div className="bg-[#09090f] content-stretch flex flex-col items-start relative size-full" data-name="Artist Detail">
      <Body />
    </div>
  );
}